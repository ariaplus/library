...
import { TweetFeeling } from '@components/tweet/tweet-feeling';

import { TweetWithLinks } from '@components/tweet/tweet-with-links';
import { TweetWithHashtags } from '@components/tweet/tweet-with-hashtags';
...
export function ViewTweet(tweet: ViewTweetProps): JSX.Element {
  ...
  const { id: ownerId, name, username, verified, verifiedred,
verifiedgreen,
verifiedbot,
verifiedcyan,
verifiedgray,
...
verifiedviolet,
verifiedwhite,
verifiedapplegreen, photoURL } = tweetUserData;
...
verifiedapplegreen={verifiedapplegreen}
      ...
      <div>
        ...
        {text && (
          <p className='whitespace-pre-line break-words text-2xl'><TweetWithLinks text={text} /><TweetWithHashtags text={text} /></p>
    )}
        {images && (
          <ImagePreview
            viewTweet
