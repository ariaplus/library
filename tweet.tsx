...
import { TweetWithHashtags } from './tweet-with-hastags';
...
verifiedapplegreen={verifiedapplegreen}
                  ...
                  <div className='flow-root '>
                           ...
                           {location !== '' && (
              <div className='ml-1 -mt-[6px] text-[11px]'>
                <TweetLocation
                  viewTweet
                  tweetLink={tweetLink}
                  location={location}
                />
                                             ...
                                             {location !== '' && (
              <div className='ml-1 -mt-[12px] text-[11px]'>
                <TweetLocation
                  viewTweet
                  tweetLink={tweetLink}
                  location={location}
              ...
              {text && (
                <p className='whitespace-pre-line break-words'><TweetWithLinks text={text} /><TweetWithHashtags text={text} /></p>
        )}
